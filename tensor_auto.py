...
for e in range(epochs):
    ...
    saver.save(sess, 'C:\\Users\\Tofu\\Desktop\\btp\\figures\\encode_model.cpkt') 
line1, = plt.plot(range(e+1), loss, 'bo', label='Training loss')
line2, = plt.plot(range(e+1), valid_loss, 'r', label='Validation loss')
plt.title('Training and validation loss')
plt.xlabel('Epochs ',fontsize=16)
plt.ylabel('Loss',fontsize=16)
plt.legend(handles = [line1,line2])
plt.savefig('C:\\Users\\Tofu\\Desktop\\btp\\graphs_figures\\final_figure.png')
...
plt.savefig('C:\\Users\\Tofu\\Desktop\\btp\\recon_images\\original.png')    
plt.figure(figsize=(20, 4))
print("Noisy Images")
for i in range(10):
    plt.subplot(2, 10, i+1)
    plt.imshow(x_test_noisy[i, ..., 0], cmap='gray')
plt.savefig('C:\\Users\\Tofu\\Desktop\\btp\\recon_images\\noisy.png')
plt.figure(figsize=(20, 4))
print("Reconstruction of Noisy Images")
for i in range(10):
    plt.subplot(2, 10, i+1)
    plt.imshow(recon_img[i, ..., 0], cmap='gray')    
plt.savefig('C:\\Users\\Tofu\\Desktop\\btp\\recon_images\\recon.png')
